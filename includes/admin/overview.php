...
<div id="cpanel">
	<div class="icon">
		<a href="admin.php?page=cfg_forms" title="Forms">
...
<div id="cpanel">
	<div class="icon">
		<a href="admin.php?page=cfg_fields" title="Fields">
			<table style="width: 100%;height: 100%;text-decoration: none;">
				<tr>
					<td align="center" valign="middle">
...
<div id="cpanel">
	<div class="icon">
		<a href="admin.php?page=cfg_templates" title="Templates">
			<table style="width: 100%;height: 100%;text-decoration: none;">
				<tr>
					<td align="center" valign="middle">
...
<div id="cpanel">
	<div class="icon" style="float: right;">
		<a href="http://creative-solutions.net/wordpress/contact-form-generator" target="_blank" title="">
			<table style="width: 100%;height: 100%;text-decoration: none;">
				<tr>
					<td align="center" valign="middle">
...
<div id="cpanel">
	<div class="icon" style="float: right;">
		<a href="http://creative-solutions.net/forum/contact-form-generator-wordpress/" target="_blank" title="">
			<table style="width: 100%;height: 100%;text-decoration: none;">
				<tr>
					<td align="center" valign="middle">
